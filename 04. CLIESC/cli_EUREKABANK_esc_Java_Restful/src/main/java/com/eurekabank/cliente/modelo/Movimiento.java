package com.eurekabank.cliente.modelo;

/**
 * Entidad Movimiento (Depósitos, Retiros, Transferencias).
 * Copia fiel del modelo del servidor para compatibilidad con la API RESTful.
 */
public class Movimiento {
    ...
    private String nombreEmpleado; // Nombre del cajero responsable
    private String tipo;
